import { db } from './db';
import { users, bibleVerses, habits, quarterlyPlans } from '@journaling/shared/db/schema';
import { randomUUID } from 'crypto';
import { BIBLE_VERSES_SEED } from '@journaling/shared/db/seed-data/bible-verses';
